...
/**
    A singleton responsible for listening for changes
    in the network connection status of the device.
*/
...
extension Reachability {
    ...
    /**
        ...
        - Returns: A `Bool` indiciating if the device is connected
                   or not. If the status can't be determined, `nil`
                   will be returned.
     */
    ...
    /**
        ...
        - Returns: A `Bool` indiciating if the device is connected
                   of not. If the status can't be determined, `nil`
                   will be returned.
    */
...
/**
    An enum that specifies the connection
