...
/**
    A singleton responsible for handling
    deep links recevied from the app delegate.
*/
...
extension DeepLinkManager {
    ...
    /**
        Initializes a BranchIO session with the launchOptions received
    ...
    */
    ...
    /**
        Responds to a URL scheme link received from
        the app delegate.
     
        - Parameter url: A `URL` representing the url that
    ...
    */
    ...
    /**
        Responds to a universal link received from
        the app delegate. It takes the current state
        of the application and notifies BranchIO.
     
        - Parameter userActivity: A `NSUserActivity` representing
