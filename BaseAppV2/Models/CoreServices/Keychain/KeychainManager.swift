...
/**
    A singleton responsible for interacting
    with Apple's Keychain API's. It uses
    dependency `KeychainAccess` for easier interaction.
*/
...
extension KeychainManager {
    ...
    /**
        ...
        - Parameters:
            - item: A `String` representing the value
    ...
    */
    ...
    /**
        ...
        - Parameters:
            - item: A `Data` representing the value
                    to store in the keychain.
            - key: A `String` representing the key
                   for `item`.
    */
...
extension KeychainManager {
    ...
    /**
        ...
        - Parameter key: A `String` representing the
                         key to the value in the keychain.
     
        - Returns: A `String?` representing the item retrieved from
                   the keychain. If it can't be retrieved, `nil`
                   will be returned.
    */
    ...
    /**
        ...
        - Returns: A `Data?` representing the item retrieved from
                   the keychain. If it can't be retrieved, `nil` will
                   be returned.
    */
