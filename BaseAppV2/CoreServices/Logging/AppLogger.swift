...
/**
    A singleton responsible for logging operations in the application. Also
    an abstraction layer for managing all logging communication to
    SwiftyBeaver.
*/
...
extension AppLogger {
    ...
    /**
        ...
        - Parameters:
            - message: A `String` representing the message that
                       would be logged in the console and in the
...
/**
    An enum that specifies the level
    type of logging.
*/
