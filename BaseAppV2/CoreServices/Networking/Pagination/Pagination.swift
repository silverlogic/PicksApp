...
/**
    A struct that incapsulates info
...
struct Pagination: Wrapper {
    ...
    /**
        Initializes an instance of `Pagination`. This
    ...
    */
    ...
    /**
        Takes a absolute string url that comes from the paginated
        response to get the query parameter `page`.
     
        - Note: This is what a absolute string url would
                look like: `https://api.baseapp.tsl.io/v1/users?page=2`
     
        - Parameter absoluteString: A `String` representing the
                                    path to the next page of results
        
        - Returns: A `Int?` representing the value of the query parameter
                   `page`. If not value exists, `nil` will be returned.
    */
...
/**
    A struct that incapsulates a paginated response
    and its results
*/
struct PaginatedResponse<T: ManyInsertable>: Wrapper {
    ...
    /**
        Initializes an instance of `PaginatedResponse`. This
        is used to conform to the protocol `Wrapper`.
    */
    init() {}
