...
extension UITableView {
    func register<T: UITableViewHeaderFooterView>(_: T.Type) where T: ResuableView {
        register(T.self, forHeaderFooterViewReuseIdentifier: T.reuseIdentifier)
    }
    
    func register<T: UITableViewHeaderFooterView>(_: T.Type) where T: ResuableView, T: NibLoadableView {
...
extension UITableView {
    func dequeueCell<T: UITableViewCell>() -> T where T: ResuableView {
...
extension UITableView {
    func dequeueHeaderFooter<T: UITableViewHeaderFooterView>() -> T where T: ResuableView {
