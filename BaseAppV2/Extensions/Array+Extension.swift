...
extension Array {
    ...
    /**
        ...
        - Parameter separator: A `String` representing the separator to place between each element in the array.
     
        - Returns: A `String` representing the elements with the given separator in between them in a textual representation.
    */
