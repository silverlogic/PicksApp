...
/**
    ...
    managing the user feed of the application.
*/
...
extension UserFeedViewController: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        guard let user = userFeedViewModel.userWithIndex(indexPath.item) else { return UICollectionViewCell () }
...
fileprivate extension UserFeedViewController {
    ...
    fileprivate func setup() {
        ...
        userFeedViewModel.endOfUsers.bind { [weak self] (end: Bool) in
    ...
    @objc private func fetchNextPageOfUsers() {
