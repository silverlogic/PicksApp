...
// MARK: - IBAction
fileprivate extension SignupOptionalInfoViewController {
    @IBAction private func signupButtonTapped(_ sender: BaseButton) {
        signupWithEmail()
    }
}
    ...
    fileprivate func setup() {
        ...
        viewModel.signUpError.bind { [weak self] (error: BaseError?) in
            ...
            if signupError.statusCode == 101 {
                ...
                strongSelf.dismissProgressHudWithMessage(signupError.errorDescription, iconType: .error, duration: nil)
            }
        }
