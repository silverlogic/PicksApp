...
/**
    ...
    of `UICollectionViewFlowLayout`. It also
    defines and sets default attributes for an
    instance. This provides horizontal flow layout
...
class BaseCollectionViewHorizontalFlowLayout: UICollectionViewFlowLayout {
    ...
    override func prepare() {
        ...
        newItemSize.height = (currentCollectionView.bounds.size.height - totalSpacingBetweenCells) / itemsPerColumn
        if itemSize.width > 0 {
