...
/**
    A `BaseCollectionViewCell` responsible for handling
    and configuring the view of a user cell.
*/
final class UserCollectionViewCell: BaseCollectionViewCell {
    
    // MARK: - IBOutlets
    @IBOutlet fileprivate weak var userProfileBackgroundImageView: BaseImageView!
...
extension UserCollectionViewCell {
    ...
    /**
        ...
        - Parameter name: A `String` representing the full name
                          of the user.
    */
