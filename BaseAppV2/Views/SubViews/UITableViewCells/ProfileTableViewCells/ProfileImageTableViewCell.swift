...
/**
    ...
    and configuring the view of a profile image of
    an user.
*/
final class ProfileImageTableViewCell: BaseTableViewCell {
    
    // MARK: - IBOutlets
    @IBOutlet fileprivate weak var profileImageView: CircleImageView!
    
    
    // MARK: - Private Class Attributes
    fileprivate static let cellHeight: CGFloat = 209.0
}
