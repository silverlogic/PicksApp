...
final class PushNotificationManagerTests: BaseAppV2UnitTests {
...
extension PushNotificationManagerTests {
    ...
    func testHandleRegistrationOfUserNotificationSettings() {
        sharedManager.handleRegistrationOfUserNotificationSettings(UIUserNotificationSettings(types: [], categories: nil))
    }
    ...
    func testHandleRegistrationOfRemoteNotificationsWithDeviceToken() {
        ...
        XCTAssertEqual(testToken, "cd33978b3a77ea3ea6cf629584d80a5ce6ec55a956f993a8f7851d02dd7cad81", "Token Not Parsed Correctly!")
    }
    ...
    func testHandleIcomingPushNotificationWithAction() {
        // @TODO: Adjust when push notifications are in use
        sharedManager.handleIncomingPushNotificationWithAction(notificationPayload: ["Bob": "Saget"], identifier: "FULL_HOUSE")
    }
}
